...
The java program tzar helps with managing many runs of sets of experiments and making them easier to reproduce.  tzar itself is documented and downloadable from https://tzar-framework.atlassian.net/wiki/display/TD/Tzar+documentation.
